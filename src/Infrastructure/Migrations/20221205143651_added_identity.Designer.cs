...
namespace Book.Infrastructure.Migrations
{
    ...
    [Migration("20221205143651_added_identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Book.Domain.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 12, 5, 9, 36, 51, 59, DateTimeKind.Local).AddTicks(570),
                            Status = false
                        });
                });
            ...
            modelBuilder.Entity("Book.Infrastructure.Entities.Identity.BookRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Book.Infrastructure.Entities.Identity.BookUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Book.Infrastructure.Entities.Identity.BookRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Book.Infrastructure.Entities.Identity.BookUser", null)
                        .WithMany()
